...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'cinnamon.nvim', 'nvim-colorizer.lua', 'null-ls.nvim', 'indent-blankline.nvim', 'FixCursorHold.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
